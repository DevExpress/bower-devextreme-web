...
if (!DevExpress.MOD_VIZ_VECTORMAP) {
    ...
    (function(DX, $, undefined) {
        ...
        var Map = DX.viz.BaseWidget.inherit({
                ...
                _afterInit: function() {
                    resumeLayersData(this._layerCollection, this._options.layers)
                },
                _initCore: function() {
                    var that = this;
        ...
        function resumeLayersData(layerCollection, options) {
    ...
    (function(DX, $, undefined) {
        ...
        strategiesByType[TYPE_LINE] = {
            ...
            getStyles: function(settings) {
                ...
                return {root: [{
                                ...
                                stroke: settings.hoveredColor || color,
                                "stroke-width": settings.hoveredWidth || width
                            }, {
                                "class": "dxm-line dxm-line-selected",
                                stroke: settings.selectedColor || color,
                                "stroke-width": settings.selectedWidth || width
                            }]}
            },
            setState: function(figure, styles, state) {
                applyElementState(figure, styles, state, "root")
        ...
        MapLayerElement.prototype = {
            ...
            dispose: function() {
                var that = this;
                that._ctx = that.proxy = that._settings = that._fig = that.data = null;
                return that
            },
            project: function() {
            ...
            draw: function() {
                ...
                that._lbl = context.settings.label.enabled ? {
            ...
            transform: function() {
                ...
                if (context.hasSeparateLabel)
                    context.str.transformLabel(that._lbl, context.projection, that._labelPrj)
            },
            refresh: function() {
                var that = this,
            ...
            _refreshLabel: function(settings) {
                ...
                if (label.value) {
                    ...
                    }).data(that._ctx.dataKey, that._data).append(label.root);
